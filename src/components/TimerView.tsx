      ...
      <div className="card text-center mb-6">
        ...
        <div className="relative inline-flex items-center justify-center mb-4">
          <svg className="w-40 h-40 -rotate-90" viewBox="0 0 160 160">
            <circle cx="80" cy="80" r="70" stroke="currentColor" strokeWidth="10" fill="none" className="text-gray-200 dark:text-gray-700" />
            <circle
              cx="80" cy="80" r="70"
          ...
          <span className={`absolute text-4xl font-bold tabular-nums ${done ? 'text-red-500' : 'text-gray-900 dark:text-gray-50'}`}>
            {mins}:{secs}
          </span>
        </div>
